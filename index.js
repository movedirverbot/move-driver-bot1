...
// - cancelado pelo administrador (corrigido)
...
// Vamos considerar ACCEPT quando:
// - NomePrestador / Veiculo / Placa preenchidos
// - OU statusLower === 'aguardando motorista'
if (
!hasDriver &&
(
(NomePrestador && Veiculo && Placa) ||
...
// (contando a partir do primeiro "aguardando motorista"/aceite)
